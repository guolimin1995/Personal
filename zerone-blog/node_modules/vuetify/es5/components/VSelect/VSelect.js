...
var baseMixins = (0, _mixins2.default)(_VTextField2.default, _comparable2.default, _filterable2.default);
/* @vue/component */
exports.default = baseMixins.extend().extend({
    ...
    computed: {
        ...
        classes: function classes() {
            return _extends({}, _VTextField2.default.options.computed.classes.call(this), {
                'v-select': true,
    ...
    methods: {
        ...
        onKeyDown: function onKeyDown(e) {
            ...
            // available options
            if (!this.isMenuActive && [_helpers.keyCodes.up, _helpers.keyCodes.down].includes(keyCode)) return this.onUpDown(e);
