...
exports.default = (0, _mixins2.default)(_header2.default).extend({
    ...
    methods: {
        ...
        genHeader: function genHeader(header) {
            ...
            var classes = ['text-xs-' + (header.align || 'start')].concat(_toConsumableArray((0, _helpers.wrapInArray)(header.class)));
