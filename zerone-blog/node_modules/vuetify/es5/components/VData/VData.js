...
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; // Helpers
...
exports.default = _vue2.default.extend({
    ...
    computed: {
        ...
        groupedItems: function groupedItems() {
            return this.isGrouped ? (0, _helpers.groupByProperty)(this.computedItems, this.internalOptions.groupBy[0]) : null;
        },
    ...
    watch: {
        ...
        sortBy: function sortBy(_sortBy) {
            this.updateOptions({ sortBy: (0, _helpers.wrapInArray)(_sortBy) });
        },
        ...
        sortDesc: function sortDesc(_sortDesc) {
            this.updateOptions({ sortDesc: (0, _helpers.wrapInArray)(_sortDesc) });
        },
        ...
        groupBy: function groupBy(_groupBy) {
            this.updateOptions({ groupBy: (0, _helpers.wrapInArray)(_groupBy) });
        },
        ...
        groupDesc: function groupDesc(_groupDesc) {
            this.updateOptions({ groupDesc: (0, _helpers.wrapInArray)(_groupDesc) });
        },
    ...
    methods: {
        ...
        updateOptions: function updateOptions(options) {
            this.internalOptions = _extends({}, this.internalOptions, options, {
