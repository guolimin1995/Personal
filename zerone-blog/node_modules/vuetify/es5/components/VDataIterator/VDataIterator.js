...
var _VDataFooter = require('./VDataFooter');

var _VDataFooter2 = _interopRequireDefault(_VDataFooter);
...
exports.default = (0, _mixins2.default)(_themeable2.default).extend({
    ...
    props: _extends({}, _VData.VData.options.props, {
        itemKey: {
            type: String,
            default: 'id'
        },
    ...
    methods: {
        ...
        genFooter: function genFooter(props) {
            ...
            return this.$createElement(_VDataFooter2.default, _extends({
