...
exports.default = (0, _mixins2.default)(_localable2.default, _picker2.default
/* @vue/component */
).extend({
    name: 'v-date-picker',
    props: {
    ...
    computed: {
        ...
        formatters: function formatters() {
            return {
                year: this.yearFormat || (0, _util.createNativeLocaleFormatter)(this.currentLocale, { year: 'numeric', timeZone: 'UTC' }, { length: 4 }),
