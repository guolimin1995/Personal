...
// Mixins
exports.default = (0, _mixins2.default)(_colorable2.default, _localable2.default
/* @vue/component */
).extend({
    ...
    computed: {
        formatter: function formatter() {
            return this.format || (0, _util.createNativeLocaleFormatter)(this.currentLocale, { year: 'numeric', timeZone: 'UTC' }, { length: 4 });
        }
    },
