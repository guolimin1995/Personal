...
var _localable = require('../../mixins/localable');

var _localable2 = _interopRequireDefault(_localable);
...
exports.default = (0, _mixins2.default)(_colorable2.default, _localable2.default, _themeable2.default
/* @vue/component */
).extend({
    ...
    computed: {
        formatter: function formatter() {
            if (this.format) {
                ...
                return (0, _util.createNativeLocaleFormatter)(this.currentLocale, { month: 'long', year: 'numeric', timeZone: 'UTC' }, { length: 7 });
            } else {
                return (0, _util.createNativeLocaleFormatter)(this.currentLocale, { year: 'numeric', timeZone: 'UTC' }, { length: 4 });
            }
        }
    },
    watch: {
