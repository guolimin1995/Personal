...
var _calendarWithEvents = require('./mixins/calendar-with-events');

var _calendarWithEvents2 = _interopRequireDefault(_calendarWithEvents);
...
/* @vue/component */
exports.default = _calendarWithEvents2.default.extend({
    name: 'v-calendar',
    ...
    computed: {
        parsedValue: function parsedValue() {
            return (0, _timestamp.validateTimestamp)(this.value) ? (0, _timestamp.parseTimestamp)(this.value) : this.parsedStart || this.times.today;
        },
