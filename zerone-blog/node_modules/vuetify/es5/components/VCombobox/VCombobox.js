...
exports.default = _VAutocomplete2.default.extend({
    ...
    methods: {
        ...
        genChipSelection: function genChipSelection(item, index) {
            ...
            if (this.multiple) {
                chip.componentOptions.listeners = _extends({}, chip.componentOptions.listeners, {
        ...
        setValue: function setValue(value) {
            _VSelect2.default.options.methods.setValue.call(this, value || this.internalSearch);
        },
