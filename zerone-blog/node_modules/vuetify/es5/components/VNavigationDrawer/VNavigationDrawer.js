...
var baseMixins = (0, _mixins2.default)((0, _applicationable2.default)('left', ['isActive', 'isMobile', 'miniVariant', 'expandOnHover', 'permanent', 'right', 'temporary', 'width']), _colorable2.default, _dependent2.default, _overlayable2.default, _ssrBootable2.default, _themeable2.default);
/* @vue/component */
exports.default = baseMixins.extend({
    ...
    computed: {
        ...
        styles: function styles() {
            ...
            var styles = {
                ...
                maxHeight: this.computedMaxHeight != null ? 'calc(100% - ' + (0, _helpers.convertToUnit)(this.computedMaxHeight) + ')' : undefined,
                transform: translate + '(' + (0, _helpers.convertToUnit)(this.computedTransform, '%') + ')',
    ...
    methods: {
        ...
        genBackground: function genBackground() {
            ...
            var image = this.$scopedSlots.img ? this.$scopedSlots.img(props) : this.$createElement(_VImg2.default, { props: props });
