...
exports.default = _VSelect2.default.extend({
    ...
    computed: {
        classes: function classes() {
            return _extends({}, _VSelect2.default.options.computed.classes.call(this), {
                'v-autocomplete': true,
        ...
        listData: function listData() {
            ...
            data.props = _extends({}, data.props, {
    ...
    methods: {
        ...
        genInputSlot: function genInputSlot() {
            var slot = _VSelect2.default.options.methods.genInputSlot.call(this);
