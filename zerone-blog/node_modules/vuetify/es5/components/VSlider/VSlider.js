...
exports.default = (0, _mixins2.default)(_VInput2.default, _loadable2.default
/* @vue/component */
).extend({
    name: 'v-slider',
    directives: {
    ...
    methods: {
        ...
        onThumbMouseDown: function onThumbMouseDown(e) {
            ...
            this.keyPressed = 2;
            this.isActive = true;
            var mouseUpOptions = _helpers.passiveSupported ? { passive: true, capture: true } : true;
            var mouseMoveOptions = _helpers.passiveSupported ? { passive: true } : false;
            if ('touches' in e) {
