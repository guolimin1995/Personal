...
exports.default = _vue2.default.extend().extend({
    ...
    methods: {
        getMaxZIndex: function getMaxZIndex() {
            ...
            var activeElements = [].concat(_toConsumableArray(document.getElementsByClassName('v-menu__content--active')), _toConsumableArray(document.getElementsByClassName('v-dialog__content--active')));
