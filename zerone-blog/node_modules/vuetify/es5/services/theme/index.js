...
var ThemeUtils = _interopRequireWildcard(_utils);
...
var Theme = exports.Theme = function (_Service) {
    ...
    _createClass(Theme, [{
        ...
        value: function initNuxt(root) {
            var options = this.options || {};
            root.$children.push(new _vue2.default({
                head: {
                    style: [{
        ...
        value: function initTheme() {
            ...
            this.vueInstance = new _vue2.default({
