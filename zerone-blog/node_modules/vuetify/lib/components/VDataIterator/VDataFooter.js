...
import '../../../src/components/VDataIterator/VDataFooter.sass';
// Components
    ...
    computed: {
        ...
        computedItemsPerPageOptions: function computedItemsPerPageOptions() {
            ...
            var itemsPerPageOptions = this.itemsPerPageOptions.map(function (option) {
                if ((typeof option === 'undefined' ? 'undefined' : _typeof(option)) === 'object') return option;else return _this.genItemsPerPageOption(option);
            });
    ...
    methods: {
        ...
        genPaginationInfo: function genPaginationInfo() {
            ...
            if (this.pagination.itemsLength) {
                ...
                children = this.$scopedSlots['page-text'] ? [this.$scopedSlots['page-text']({ pageStart: pageStart, pageStop: pageStop, itemsLength: itemsLength })] : [this.$vuetify.lang.t('$vuetify.dataIterator.pageText', pageStart, pageStop, itemsLength)];
            }
            return this.$createElement('div', {
